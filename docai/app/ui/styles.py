...
QPushButton#previewOpenBtn {{
    background: transparent; border: 1px solid {COLORS['border']};
    border-radius: 6px; padding: 4px 12px; font-size: 12px;
}}
QPushButton#previewOpenBtn:hover {{ border-color: {COLORS['text']}; }}
QPushButton#previewOpenWithBtn {{
    background: {COLORS['primary']}; color: white; border: none;
    border-radius: 6px; padding: 4px 12px; font-size: 12px; font-weight: 600;
}}
QPushButton#previewOpenWithBtn:hover {{ background: #333333; }}
...
QPushButton.docTypeCard:checked {{
    border: 2px solid {COLORS['accent']}; background: #FBFCFE;
}}
QPushButton#createConfirmBtn {{
    background: {COLORS['primary']}; color: white; border: none;
    border-radius: 11px; padding: 11px 0; font-weight: 600; font-size: 13px;
}}
QPushButton#createConfirmBtn:hover {{ background: #333333; }}
QPushButton#createConfirmBtn:disabled {{ background: #9B9B96; }}

QFrame#quotaWarningCard {{
    background: #FBF7F2; border: 1px solid #F3D3CE; border-radius: 11px;
}}
QLabel#quotaWarningTitle {{
    color: #B03225; font-size: 12.5px; font-weight: 600; background: transparent;
}}
QLabel#quotaWarningHint {{
    color: #8A6D4B; font-size: 11.5px; background: transparent;
}}

QFrame#genErrorCard {{
    background: white; border: 1px solid #F3D3CE; border-radius: 11px;
}}
QFrame#genErrorHead {{
    background: #FBF3F2; border-bottom: 1px solid #FBECEA;
    border-top-left-radius: 11px; border-top-right-radius: 11px;
}}
QLabel#genErrorIcon {{
    background: #FBECEA; color: {COLORS['danger']}; border-radius: 6px;
    font-size: 12px;
}}
QLabel#genErrorTitle {{
    color: #B03225; font-size: 12px; font-weight: 600; background: transparent;
}}
QLabel#genErrorProgress {{
    color: #C08B84; font-size: 10.5px; background: transparent;
}}
QLabel#genErrorBody {{
    color: {COLORS['muted']}; font-size: 11.5px; padding: 10px 13px;
    background: transparent;
}}
